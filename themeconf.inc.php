...
function load_pattern()
{
  ...
  elseif (file_exists(PHPWG_ROOT_PATH.'themes/hr_glass_xl/'.$pwgversion_array[0].'.pattern.php'))
  {
    include(PHPWG_ROOT_PATH.'themes/hr_glass_xl/'.$pwgversion_array[0].'.pattern.php');
    return true;
  }
  else
  {
